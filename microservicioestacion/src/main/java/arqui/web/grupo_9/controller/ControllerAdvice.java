...
public class ControllerAdvice {
    ...
    @ExceptionHandler(value = NotValidUbicacionException.class)
    public ResponseEntity<ExcepcionDTO> notValidUbicacionExceptionHandler(NotValidUbicacionException ex) {
